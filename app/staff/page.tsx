...
export default async function StaffPage() {
  ...
  const links: [string, string, StaffPermission][] = [["ニュース", "/admin/news", "news_write"], ["憲章", "/admin/constitution", "constitution_write"], ["投票", "/admin/polls", "poll_manage"], ["メッセージ", "/admin/messages", "message_publish"], ["背景・演出", "/admin/settings", "media_manage"]];
